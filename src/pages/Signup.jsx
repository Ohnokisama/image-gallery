      ...
      <div className='w-[100%] md:w-[50%] h-full flex items-center px-6 md:px-12'>
        <form className='w-full' onSubmit={handleSubmit}>
          ...
          <div className='my-4'>
            ...
            <p className='mt-3 text-gray-700'>Sign up to download free images</p>
          </div>
          <div className='my-5'>
          ...
          <button type="submit" className='py-4 px-12 bg-violet-600 text-white rounded hover:bg-violet-900 transition-all'>Register</button>
